...
import com.dgs.springbootlibrary.requestmodels.PaymentInfoRequest;
import com.dgs.springbootlibrary.service.PaymentService;
...
public class PaymentController {
    ...
    public ResponseEntity<String> createPaymentIntent(
        ...
        PaymentIntent paymentIntent =
                paymentService.createPaymentIntent(paymentInfoRequest);

        String paymentStr = paymentIntent.toJson();
        log.debug("paymentStr = {}", paymentStr);
